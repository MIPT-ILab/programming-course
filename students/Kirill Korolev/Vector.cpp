...
|	                                                                              |
|	@note The two vertions of the operator are for different orders of parametres.|
|	                                                                              |
**********************************************************************************/
...
|																				  |
|	@note The constructor creates a vector with different coordinates x and y and |
|		  print a messege about creation.										  |
|																				  |
**********************************************************************************/
