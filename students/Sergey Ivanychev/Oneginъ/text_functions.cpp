...
/**
		input_analyse					function analyses the input text for the amount of meaning chars and strings
		@param[out]		stream			file stream
		@param[out]		char_counter	variable contains the amount of meaning chars
		@param[out]		str_counter		variable contains the amount of meaning strings
...
/**
		input_scan						function scans the text from the stream getting only meaning chars and strings
		@param[out]		stream			file stream
		@param[out]		buffer			pointer to the memory area where the input text is contained
		@param[out]		links			pointer to the memory area where the pointers to the strings are contained
...
int get_text(FILE* stream, text * save_text)
{
	...
	void* inp_text = calloc(1, ( char_counter) * sizeof(char) + str_counter * sizeof(char*));
