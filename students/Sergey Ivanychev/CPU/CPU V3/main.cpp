/**
	...
	@par				Available commands (1.2 Beta 1) :
						...
						- mov {to register} {from: register or value}
						- swap
						- dub
						- jmp {mark}
						- jbe
	...
	@par				Changelog V1.2 Beta 1
						...
						-- There're lots of new instructions added like jmp, jbe, jb, jae, ja, je, jne
						-- Added function cpu_core that configures the work of the whole processor
...
/**
	main				rules io, calls asm, initializes and deletes CPU
	@return				0;
**/
